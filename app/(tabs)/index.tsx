...
export default function HomeScreen() {
  ...
  const stepGoal = Math.max(1, state.profile.stepGoal);
  ...
  const waterPercent = Math.min(
    100,
    Math.round((todayWaterMl / waterGoal) * 100)
  );
        ...
        <View style={styles.loading}>
          <View
            style={[
              ...
              {
                backgroundColor: `${STEP_GREEN}18`,
                borderColor: `${STEP_GREEN}35`,
              },
            ]}
          >
            <Ionicons
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerText}>
            <Subtitle>Daily overview</Subtitle>
          ...
          <Pressable
            ...
            style={({ pressed }) => [
              ...
              {
                backgroundColor: `${STEP_GREEN}16`,
                borderColor: `${STEP_GREEN}30`,
        ...
        >
          <View style={styles.stepHeader}>
            ...
            <View
              style={[
                styles.liveBadge,
                {
                  backgroundColor: `${STEP_GREEN}12`,
                  borderColor: `${STEP_GREEN}28`,
                },
              ]}
            >
              <View
          ...
          <View style={styles.stepBottom}>
            <View style={styles.stepBottomItem}>
              <Text
                style={[
                  styles.bottomValue,
                  { color: c.text },
        ...
        <View style={styles.actionsGrid}>
          ...
          <QuickAction
            title="Weight"
            subtitle={`${latestWeightKg.toFixed(1)} kg`}
            icon="scale-outline"
        ...
        >
          <StatusRow
            ...
            title="Steps"
            value={`${formatNumber(today.steps)} / ${formatNumber(stepGoal)}`}
            progress={stepProgress}
            c={c}
          />
          ...
          <StatusRow
            icon="water-outline"
            title="Water"
            value={`${(todayWaterMl / 1000).toFixed(1)} / ${(waterGoal / 1000).toFixed(1)} L`}
            progress={Math.min(1, todayWaterMl / waterGoal)}
            c={c}
          />
          ...
          <StatusRow
            ...
            progress={Math.min(1, caloriesConsumed / calorieGoal)}
            c={c}
          />
        </View>
